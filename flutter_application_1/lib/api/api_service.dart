...
class ApiService {
  ...
  /// The url to be used for the testing api calls ()
  ...
  /// Get HonorMed token from the preferences ()
  ...
  Future sendPdf() async {
    final response = await http.post(
      Uri.parse('$honorApi/upload-file/'),
      headers: <String, String>{
        'Content-Type': 'application/json',
      },
      // TODO: Change the binary to the obtained file
      body: jsonEncode(<String, dynamic>{
        "binary":
